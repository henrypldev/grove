...
<Callout>
Tailscale needs to be set up on both your Mac **and** your phone before Grove can work remotely. See the [Tailscale Setup](/docs/tailscale) guide for step-by-step instructions.
</Callout>
