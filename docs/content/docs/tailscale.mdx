...
|---------|-------------|----------|
| **Funnel** | Exposes a path on your Tailscale hostname over HTTPS | The Grove API and WebSocket at `https://<your-machine>.tail-net.ts.net/grove` |
...
2. Sets up a Funnel at the `/grove` path for the REST API and WebSocket
