...
import { getServerUrl, setServerUrl, getTerminalHost, setTerminalHost } from '@/services/api'
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <Text style={styles.hint}>
        Tailscale Funnel URL for API requests
      </Text>

      <Text style={[styles.label, styles.labelSpaced]}>Terminal Host (Direct)</Text>
      <TextInput
        style={styles.input}
        value={host}
